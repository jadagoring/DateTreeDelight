...
<div class="inq-body">
    <table>
        ...
        <?php
        $query = "SELECT * FROM inquirylog WHERE completed = 0 ORDER BY id ASC";
        ...
        ?>
                <form action="inquiryinfo.php" method="POST">
                    <tr>
                        ...
                        <td style="text-align: center;"><input type="submit" value="Answer" name="deleteusr" class="btn btn-success"></td>
